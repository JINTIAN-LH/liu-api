...
public class InterfaceInfoController {
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        String fullUrl = oldInterfaceInfo.getUrl();
        String method = oldInterfaceInfo.getMethod();
        User loginUser = userService.getLoginUser(request);
        String accessKey = loginUser.getAccessKey();
        String secretKey = loginUser.getSecretKey();
        YuApiClient tempClient = new YuApiClient(accessKey, secretKey);
        String result = tempClient.invokeInterface(fullUrl, userRequestParams, method);
        return ResultUtils.success(result);
        /**todo
         * 使用该方法之后，确保每个api接口的url都为固定格式，
         * 例如http://localhost:8123/api/name/liuhao
         */
//        Gson gson = new Gson();
//        model.com.liu.apiclientsdk.User user = gson.fromJson(userRequestParams, model.com.liu.apiclientsdk.User.class);
